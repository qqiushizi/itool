...
```bash
OP_SPEC_MODE=llm OP_DESC_LLM='实现矩阵乘法 MatMulCustom...' ITOOL_LLM_API_BASE=http://127.0.0.1:8000/v1 ITOOL_LLM_MODEL=Qwen/Qwen2.5-7B-Instruct bash d.ops_develop/d.op_design/a.op_spec/run.sh
```
...
```bash
OP_SPEC_MODE=manual bash d.ops_develop/d.op_design/a.op_spec/run.sh
```
