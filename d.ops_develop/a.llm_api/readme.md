...
```bash
bash d.ops_develop/a.llm_api/run.sh              # 菜单
bash d.ops_develop/a.llm_api/run.sh config       # 直接配置
bash d.ops_develop/a.llm_api/run.sh view         # 查看当前配置
bash d.ops_develop/a.llm_api/run.sh test         # 测试连接
```
...
bash d.ops_develop/a.llm_api/run.sh config
```
